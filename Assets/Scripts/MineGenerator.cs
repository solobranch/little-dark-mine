...
namespace solobranch {
    public class MineGenerator : MonoBehaviour {
        ...
        [SerializeField] private int maxRetries = 1000;
        ...
        public void GenerateMine() {
            ...
            while (roomsPlaced < minRoomCount && retries < maxRetries) {
                ...
                neighbors.ForEach(x => Debug.Log(x));
            ...
            if (roomsPlaced < minRoomCount) {
                Debug.LogWarning(
                    "Minimum room count not reached. Consider increasing grid size or adjusting parameters.");
            }
        }
        ...
        public void ClearMine() {
            roomList.Clear();
            grid = new bool[gridWidth, gridHeight];
            roomObjects.ForEach(DestroyImmediate);
        }
    }
}